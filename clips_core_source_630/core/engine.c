...
//madianyi End
   ...
   while ((theActivation != NULL) &&
          ...
          (EngineData(theEnv)->HaltRules == FALSE))
     {
      ...
      //madianyi Begin
      /*========================================*/
      /* Remove the localFactList of rule. */
      /*========================================*/
	  ExecutingRule = EngineData(theEnv)->ExecutingRule;
      indexFact = ExecutingRule->lastLocalFact;
      while (indexFact != NULL)
      	 {
         /*========================================*/
         /* Remove the indexFact from localFactList of rule. */
         /*========================================*/
         ExecutingRule->lastLocalFact = indexFact->previousLocalFact;

         /*========================================*/
         /* Free the  Local Fact of the indexFact. */
         /*========================================*/
         ReturnFact(theEnv, indexFact->localFact);
